...
def test_can_create_multiple_monthly_budgets(self):
  ...
  amount= 7000
  Helpers.create_a_monthly_budget(self, category_name, amount, budget_date.strftime("%Y-%m-%d"))
...
def test_can_not_create_multiple_monthly_budgets_for_the_same_month(self):
  # TODO Franks wants to fix the budget he has just create (changing its amount)
  pass